                ...
                {paymentSuccess === true ? (
                    ...
                    <div className="flex max-xl:flex-wrap gap-10 mt-10 justify-between bg-[url('/images/grid.png')] bg-contain bg-no-repeat bg-right ">
                        <div className="flex max-w-150 flex-col  items-start text-start">
                            ...
                            <Button className="mt-16 w-full max-w-83 px-5 py-3 bg-[#2EAA62] shadow-[0px_1px_2px] shadow-[#1018280A] rounded-lg text-white font-inter font-semibold text-2xl max-md:text-xl duration-300 ease-in-out" onClick={() => navigate("/announcements")}
                            >{t("Вернуться")}</Button>
                        </div>
                        ...
                        <div className="mt-10 mb-20 w-full flex justify-center px-4 sm:px-0">
                            <div className="w-full max-w-[400px] text-center">
                                ...
                                <Button
                                    ...
                                    } className="w-full px-5 py-3 rounded-lg bg-[#2EAA62] text-white cursor-pointer"
                                >
                                    {t("Оплатить")}
                                </Button>
                            </div>
