...
import { Breadcrumbs, CardSection, Header, Pagination, PopularSliderSection, Footer, Heading, Button, Input, Paragraph, Filters } from "../../components";
                ...
                <div className="flex px-[192px] py-[30px] pb-10 gap-10 items-start">
                    ...
                    <main className="flex-1 justify-end">
                        <div className="flex justify-end gap-x-4">
                            <Button onClick={() => { }} className={"px-5 py-3 bg-[#31B683] text-white rounded-[6px]"}>Добавить объявление</Button>
