    ...
    return (
        <div className={"fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600" + (isMobileUI ? ' hidden' : 'block md:hidden')}>
            <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
                <Applink to="/" className={"inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" + (location.pathname === '/' ? ' text-[#2EAA7B]' : '')}>
                ...
                <Applink to="/business" className={"inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" + (location.pathname.includes('business') ? ' text-[#2EAA7B]' : '')}>
                ...
                <Applink to="/franchise" className={"inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" + (location.pathname.includes('franchise') ? ' text-[#2EAA7B]' : '')}>
                ...
                <Applink to="/investments" className={"inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" + (location.pathname.includes('investments') ? ' text-[#2EAA7B]' : '')}>
                ...
                <Applink to="/startup" className={"inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" + (location.pathname.includes('startup') ? ' text-[#2EAA7B]' : '')}>
