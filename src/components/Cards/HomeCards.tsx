        ...
        <div className={containerClass}>
            ...
            {allViewLink && (
                <div className="group h-full w-full">
                    <Applink to={allViewLink} className="flex h-full justify-center hover:text-white group-hover:bg-[#2EAA62] transition items-center border border-[#2EAA62] rounded-[8px]">
                        <div className="flex flex-row md:flex-col justify-center items-center pt-2 pb-2 gap-2">
                            <span className="text-xl group-hover:text-white text-[#2EAA62]">{t("Посмотреть все")}</span>
                            <FaArrowRight className="text-[#2EAA62] mt-2 group-hover:text-white" />
                        </div>
                    </Applink>
                </div>
