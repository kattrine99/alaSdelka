                    ...
                    <div className="container mx-auto flex justify-end">
                        <div className="flex gap-12.5 ">
                            <div className="flex gap-x-12.5 gap-y-1 flex-wrap">
                                <Paragraph
                                    className="flex items-center gap-1 text-[#232323] font-openSans font-normal text-[16px] leading-[125%]">
                                    <IoIosMail className="text-[#2EAA7B] text-base"/>
                                    info@name-com.uz
                                </Paragraph>
                                <Paragraph
                                    className="flex items-center gap-1 text-[#232323] font-inter font-normal text-[16px] leading-[125%]">
                            ...
                            <div className="md:flex gap-3">
                                ...
                                <Applink to="#"
                                         className="w-8 h-8 rounded-full bg-[#0DC143] flex items-center px-[7.23px]">
